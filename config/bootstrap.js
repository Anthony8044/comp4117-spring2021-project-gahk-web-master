...
module.exports.bootstrap = async function (done) {
  ...
  if (await User.count() == 0) {
    await User.createEach([
      { Username: 'user1', Password: await bcrypt.hash('user123456', 10), role: 'user', ChiName: '用戶1', EngName: 'User1', Email: 'kenny@user.com', Date: new Date() },
      { Username: 'admin1', Password: await bcrypt.hash('hkbu123456', 10), role: 'admin', ChiName: '管理員1', EngName: 'Administrator', Email: 'kenny@admin.com', Date: new Date() },
      { Username: 'admin1', Password: await bcrypt.hash('hkbu123456', 10), role: 'admin', ChiName: '管理員1', EngName: 'Administrator', Email: 'user1@admin.com', Date: new Date() },
      { Username: 'admin2', Password: await bcrypt.hash('hkbu123456', 10), role: 'admin', ChiName: '管理員2', EngName: 'Administrator', Email: 'user2@admin.com', Date: new Date() },
      { Username: 'admin3', Password: await bcrypt.hash('hkbu123456', 10), role: 'admin', ChiName: '管理員3', EngName: 'Administrator', Email: 'user3@admin.com', Date: new Date() },
      { Username: 'coach1', Password: await bcrypt.hash('hkbu123456', 10), role: 'coach', ChiName: '陳大文', EngName: 'Coach', Email: 'coach@coach.com', Date: new Date() },
      { Username: 'coach2', Password: await bcrypt.hash('hkbu123456', 10), role: 'coach', ChiName: '陳大文', EngName: 'Coach', Email: 'coach2@coach.com', Date: new Date() },
      { Username: 'coach3', Password: await bcrypt.hash('hkbu123456', 10), role: 'coach', ChiName: '陳大文', EngName: 'Coach', Email: 'coach3@coach.com', Date: new Date() },
      { Username: 'coach4', Password: await bcrypt.hash('hkbu123456', 10), role: 'coach', ChiName: '陳大文', EngName: 'Coach', Email: 'coach4@coach.com', Date: new Date() },
      { Username: 'member1', Password: await bcrypt.hash('hkbu123456', 10), role: 'member', ChiName: '陳大文', EngName: 'member1', Email: 'member1@member.com', Date: new Date() },
      { Username: 'athlete1', Password: await bcrypt.hash('hkbu123456', 10), role: 'athlete', ChiName: '陳大文', EngName: 'athlete1', Email: 'athlete@athlete.com', Date: new Date() },
    ]);
  }
  ...
  if (await News.count() == 0) {
    await News.createEach([
      { "category": "特別通告以及本會運動員及海外比賽消息", "startDate": new Date('2019-10-16'), "content": "本會熱烈恭賀香港技巧體操隊員林曉勵、栗島晴楓在2019年10月7日至10月13日於烏茲別克舉辦之技巧體操亞洲錦標賽2019女子雙人決賽中以19.570分，取得第3名!", "attachment": "", "attachmentName": "", "userGroup": ["member", "judge"] },
      { "category": "特別通告以及本會運動員及海外比賽消息", "startDate": new Date('2019-10-16'), "content": "本會熱烈恭賀香港體操隊員石偉雄在2019年10月4日至10月13日於德國史特加舉辦之第49屆競技體操世界錦標賽男子跳馬決賽中以14.466分，取得第7名，這成績使其成功贏取東京奧運參賽資格！", "attachment": "", "attachmentName": "", "userGroup": ["member", "coach"] },
      { "category": "特別通告以及本會運動員及海外比賽消息", "startDate": new Date('2019-09-24'), "content": "恭喜香港健美體操隊在2019年9月10 日至15日於上海舉辦之2019年全國健美操聯賽第四站取得優異成績。 運動員葉慧雯、吳倩儀、吳浩嵐、胡栢賢及李泳怡於成人組精英組五人操進入決賽；葉慧雯、吳倩儀及吳浩嵐更以第七名的成績晉級決賽，成續優異。", "attachment": "", "attachmentName": "", "userGroup": ["member", "athlete"] },
    ]);
  }
  ...
  if (await Events.count() == 0) {
    await Events.createEach([
      { discipline: "競技體操", category: "國際邀請賽", start: new Date('2021-11-16 10:30:00'), end: new Date("2021-11-20 12:30:00"), title: "2020年全港競技體操公開及新秀比賽暨國際邀請賽(趙惠中盃)", venue: "馬鞍山體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "彈網", category: "國際邀請賽", start: new Date('2021-7-5 11:10:00'), end: new Date("2021-8-6 12:30:00"), title: "2020年香港國際彈網邀請賽", venue: "馬鞍山體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "健美體操", category: "分齡賽", start: new Date('2021-12-19 08:30:00'), end: new Date("2021-12-20 10:30:00"), title: "2020年全港十八區健美體操分齡比賽", venue: "蕙荃體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "彈網", category: "公開賽", start: new Date('2021-10-18 09:00:00'), end: new Date("2021-10-20 10:30:00"), title: "第二十二屆香港中學彈網錦標賽", venue: "港灣道體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "技巧體操", category: "公開賽", start: new Date('2021-09-21 12:00:00'), end: new Date("2021-09-24 15:30:00"), title: "2021年香港技巧體操公開賽", venue: "馬鞍山體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "技巧體操", category: "分齡賽", start: new Date('2021-10-03 07:30:00'), end: new Date("2021-10-03 16:20:00"), title: "2021/2022年度全港技巧體操分齡賽", venue: "馬鞍山體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "健美體操", category: "公開賽", start: new Date('2021-08-22 09:40:00'), end: new Date("2021-08-24 18:00:00"), title: "第十八屆全港學界健美體操比賽", venue: "蕙荃體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "彈網", category: "分齡賽", start: new Date('2021-06-05 10:30:00'), end: new Date("2021-06-06 12:30:00"), title: "2021年全港彈網分齡賽", venue: "港灣道體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "藝術體操", category: "分齡賽", start: new Date('2021-05-01 08:30:00'), end: new Date("2021-05-02 14:00:00"), title: "2021年全港藝術體操分齡比賽", venue: "蕙荃體育館", remarks: "", attachment: "http://www.gahk.org.hk/doc/Website_49thWorld%20Championships.pdf", attachmentName: "PDF1", links: "https://gahk-web.herokuapp.com/competition/form/GRGS", linksName: "Form A" },
      { discipline: "技巧體操", category: "公開賽", start: new Date('2021-11-29 15:30:00'), end: new Date("2021-11-30 16:30:00"), title: "2021年香港技巧體操公開賽", venue: "馬鞍山體育館", remarks: "", attachment: "", attachmentName: "", links: "", linksName: "" },
      { discipline: "競技體操", category: "公開賽", start: new Date('2020-01-22 14:00:00'), end: new Date("2020-01-24 15:30:00"), title: "2020/2021年度全港競技體操公開及新秀比賽", venue: "馬鞍山體育館", remarks: "因應新型冠狀病毒的最新發展，以及預防及控制疾病(禁止羣組聚集)規例，本會未能安排2020-2021年度全港競技體操公開及新秀比賽之頒獎典禮。本會已電郵有關安排予得獎者，敬請留意。如未有收到電郵，請與本會職員聯絡，謝謝。", attachment: "", attachmentName: "", links: "", linksName: "" },
    ]);
  }
