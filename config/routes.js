...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  //'/competition': { view: 'pages/competition/calendar' },
  // alternate calendar page for testing
  '/competition': { view: 'pages/competition/calendarAlt' },
...
//  'POST /coach/update_coach/:id': 'CoachController.update_coach',
  ...
  // 'GET /competition':'EventsController.calendar',
  'GET /events/json': 'EventsController.json',

  
  'GET /competition': 'EventsController.filter',          //updated
  //'GET /competition/filter': 'EventsController.filter', //updated
  ...
  '/admin/news/create': 'AdminController.news_create',
  ...
  'GET /admin/events': 'AdminController.event_list',
  '/admin/events/create': 'AdminController.events_create',
  '/admin/events/detail/:id': 'AdminController.events_detail',
  'DELETE /admin/events/detail/:id': 'AdminController.events_delete',
